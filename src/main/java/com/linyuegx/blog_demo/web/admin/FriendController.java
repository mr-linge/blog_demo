...
//    编辑友链
    ...
    public String editPost(@Valid FriendLink friendLink, BindingResult result, @PathVariable Long id, RedirectAttributes attributes,Model model,Pageable pageable) {
        friendLink.setCreateTime(new Date());
